...
class Loggix_Core
{
    ...
    const LOGGIX_SQLITE_2         = '/data/loglite.sqlite.db';  // SQLite type 2
    const LOGGIX_SQLITE_3         = '/data/loglite.sqlite3.db'; // SQLite type 3
    const LOGGIX_MYSQL_HOST       = '127.0.0.1'; // MySQL hostname : "localhost" and "127.0.0.1" are common.
    const LOGGIX_MYSQL_DBNAME     = 'loglite';    // MySQL database name
